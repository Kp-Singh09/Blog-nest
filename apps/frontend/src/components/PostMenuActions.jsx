...
const PostMenuActions = ({ post }) => {
  ...
  useEffect(() => {
    console.log("PostMenuActions mounted. Initial props:", { post });
    console.log("Initial Clerk state:", { isLoaded, user });
  }, []);
  ...
  if (!isLoaded) {
    console.log("Clerk is not loaded yet. Rendering nothing.");
    return null; 
  }
  
  console.log("Clerk is loaded. User object:", user);
  ...
  console.log("Permission checks:", {
    ...
    postAuthorClerkId: post?.user?.clerkUserId,
    isAuthor,
    roleFromClerk: user?.publicMetadata?.role,
    isAdmin,
  });
  ...
  const handleDelete = () => {
    console.log("handleDelete called. Checking permissions:", { isAuthor, isAdmin });
  ...
  const handleFeature = () => {
    console.log("handleFeature called. Checking permissions:", { isAdmin });
  ...
  return (
    <>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20px" height="20px">
          <path d="M12 4C10.3 4 9 5.3 9 7v34l15-9 15 9V7c0-1.7-1.3-3-3-3H12z" stroke="black" strokeWidth="2" fill={isSaved ? "black" : "none"} />
        </svg>
